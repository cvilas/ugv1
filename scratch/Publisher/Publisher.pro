...
GRAPE_DIR = /home/vilas/Projects/grape
UGV1_DIR = /home/vilas/Projects/ugv1

win32:LCM_DIR = $${PWD}/ThirdParty/windows/lcm
unix:!android: LCM_DIR = /usr/local
android: LCM_DIR = $${UGV1_DIR}/ThirdParty/android/lcm
...
LIBS += -L$${PWD}/lib/ -L$${UGV1_DIR}/lib -L$${GRAPE_DIR}/lib -L$${LCM_DIR}/lib
...
CONFIG(debug, release|debug) {
    ...
    else:unix: LIBS += -lUgv1Agentd -lGrapeCored $${LCM_DIR}/lib/liblcm.la
    unix:!android: LIBS += -lpthread -lrt
} else {
    win32:LIBS += -lUgv1Agent0 -lws2_32 -lUser32 -lGrapeCore0
    else:unix: LIBS += -lUgv1Agent -lGrapeCore $${LCM_DIR}/lib/liblcm.la
    unix:!android: LIBS += -lpthread -lrt
}
