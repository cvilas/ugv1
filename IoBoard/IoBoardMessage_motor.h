...
class UGV1IOB_DLL_API SetMotorParametersCommand : public IoBoardCommand
{
public:
...
class UGV1IOB_DLL_API WriteMotorSpeedCommand : public IoBoardCommand
{
public:
...
class UGV1IOB_DLL_API ReadMotorSpeedCommand : public IoBoardCommand
{
public:
...
class UGV1IOB_DLL_API ReadMotorSpeedResponse : public IoBoardResponse
{
public:
...
class UGV1IOB_DLL_API ReadMotorCurrentCommand : public IoBoardCommand
{
public:
...
class UGV1IOB_DLL_API ReadMotorCurrentResponse : public IoBoardResponse
{
public:
...
class UGV1IOB_DLL_API SetMotorPidGainsCommand : public IoBoardCommand
{
public:
...
class UGV1IOB_DLL_API SetMotorDriveModeCommand : public IoBoardCommand
{
public:
...
/// \see SetMotorDriveModeCommand
class UGV1IOB_DLL_API WriteMotorPowerCommand : public IoBoardCommand
{
public:
...
class UGV1IOB_DLL_API ReadMotorEncodersCommand : public IoBoardCommand
{
public:
...
class UGV1IOB_DLL_API ReadMotorEncodersResponse : public IoBoardResponse
{
public:
...
class UGV1IOB_DLL_API ResetMotorEncodersCommand : public IoBoardCommand
{
public:
